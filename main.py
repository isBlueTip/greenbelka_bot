...
def sort_start(call):
    if call.message:
        ...
        bot.send_message(
            ...
            "Возьми предмет, который хочешь сдать на переработку " + "и отвечай на мои вопросы.",
            parse_mode="html",
        )
        bot.send_message(
            call.message.chat.id, "Из какого материала сделан предмет?", parse_mode="html", reply_markup=markup
        )
...
def several_materials(call):
    ...
    bot.send_message(
        call.message.chat.id, "Материалы можно отделить друг от друга?", parse_mode="html", reply_markup=markup
    )
...
def divide(call):
    ...
    bot.send_message(
        call.message.chat.id,
        "Нужно разделить на части и для каждой пройти тест отдельно",
        parse_mode="html",
        reply_markup=markup,
    )
...
def not_divide(call):
    ...
    bot.send_message(call.message.chat.id, "Это техника или батарейка?", parse_mode="html", reply_markup=markup)
...
def technic(call):
    bot.send_message(
        call.message.chat.id,
        "Принимается на акции. <i><b>Батарейки с аккумуляторами</b></i> отдельно, " + "<i><b>техника</b></i> отдельно",
        parse_mode="html",
    )
...
def paper(call):
    if call.data == "бумага":
        ...
        bot.send_message(
            call.message.chat.id,
            "Это втулка, упаковка от яиц или подобные им (см.фото)?",
            parse_mode="html",
            reply_markup=markup,
        )
        ...
        bot.send_message(
            call.message.chat.id,
            "На бумаге есть ламинация (плёнка, проверяется на надрыв)?",
            parse_mode="html",
            reply_markup=markup,
        )
        ...
        bot.send_message(call.message.chat.id, "На бумаге есть пятна жира?", parse_mode="html", reply_markup=markup)
    elif call.data == "бумага, без жира":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Да", callback_data="не принимается"))
        markup.add(types.InlineKeyboardButton("Нет", callback_data="бумага, не чек"))
        bot.send_message(
            call.message.chat.id, "Это кассовый чек или пергамент?", parse_mode="html", reply_markup=markup
        )
...
def glass(call):
    if call.data == "стекло":
        ...
        bot.send_message(
            call.message.chat.id,
            "Это лампочка, зеркало, градусник или хрустальная посуда?",
            parse_mode="html",
            reply_markup=markup,
        )
        ...
        bot.send_message(call.message.chat.id, "Это стеклянная посуда?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(
            call.message.chat.id, "Это прозрачная стеклянная посуда?", parse_mode="html", reply_markup=markup
        )
        ...
        bot.send_message(
            call.message.chat.id,
            "Принимается на акции в <i><b>стекло</b></i>, но целую посуду лучше "
...
def metal(call):
    if call.data == "металл":
        ...
        bot.send_message(call.message.chat.id, "Металл магнитится?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(
            call.message.chat.id,
            "Это консервная банка или закатывающаяся крышка от солений?",
            parse_mode="html",
            reply_markup=markup,
        )
        ...
        bot.send_message(call.message.chat.id, "Смятая?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(
            call.message.chat.id,
            "Консервную банку лучше сложить, как показано на фото.",
            parse_mode="html",
            reply_markup=markup,
        )
    elif call.data == "металл, жесть консервная":
        bot.send_message(
            call.message.chat.id, "Принимается на акции в <i><b>Жесть консервная</b></i>.", parse_mode="html"
        )
        main_menu(call.message)
        ...
        bot.send_message(call.message.chat.id, "Это сковорода?", parse_mode="html", reply_markup=markup)
    elif call.data == "металл, жесть сковорода":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Сделано", callback_data="металл, жесть прочая"))
        bot.send_message(
            call.message.chat.id, "Нужно убрать все пластиковые ручки.", parse_mode="html", reply_markup=markup
        )
    elif call.data == "металл, жесть прочая":
        bot.send_message(call.message.chat.id, "Принимается на акции в <i><b>Жесть прочая</b></i>.", parse_mode="html")
        main_menu(call.message)
        ...
        bot.send_message(call.message.chat.id, "Это фольга?", parse_mode="html", reply_markup=markup)
    elif call.data == "металл, фольга":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Да", callback_data="металл, алюминиевая фольга"))
        markup.add(types.InlineKeyboardButton("Нет", callback_data="не принимается"))
        bot.send_message(call.message.chat.id, "Если смять, остаётся смятой?", parse_mode="html", reply_markup=markup)
    elif call.data == "металл, алюминиевая фольга":
        bot.send_message(
            call.message.chat.id, "Принимается на акции в <i><b>Алюминиевая фольга</b></i>.", parse_mode="html"
        )
        main_menu(call.message)
        ...
        bot.send_message(
            call.message.chat.id, "Это алюминиевая банка из-под напитка?", parse_mode="html", reply_markup=markup
        )
        ...
        bot.send_message(call.message.chat.id, "Банку лучше смять.", parse_mode="html", reply_markup=markup)
    elif call.data == "металл, алюминиевая банка":
        bot.send_message(
            call.message.chat.id, "Принимается на акции в <i><b>Алюминиевая банка</b></i>.", parse_mode="html"
        )
        main_menu(call.message)
        ...
        bot.send_message(call.message.chat.id, "Это баллон под давлением?", parse_mode="html", reply_markup=markup)
    elif call.data == "металл, алюм баллон":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Сделано", callback_data="металл, алюминий прочий"))
        bot.send_message(call.message.chat.id, "Нужно проколоть.", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(
            call.message.chat.id, "Принимается на акции в <i><b>Алюминий прочий</b></i>.", parse_mode="html"
        )
        main_menu(call.message)
...
def plastic(call):
    if call.data == "пластик":
        ...
        markup.add(types.InlineKeyboardButton("Есть, 3 (PVC), 7 (OTHER)", callback_data="не принимается"))
        markup.add(types.InlineKeyboardButton("Есть, цифра больше 7 (С/...)", callback_data="не принимается"))
        markup.add(types.InlineKeyboardButton("Нет", callback_data="пластик, бм"))
        markup.add(types.InlineKeyboardButton("Подробнее о маркировках", callback_data="маркировка" + call.data))
        bot.send_message(call.message.chat.id, "На изделии есть маркировка?", parse_mode="html", reply_markup=markup)
...
def plastic1(call):
    if call.data == "пластик, 1":
        ...
        markup.add(types.InlineKeyboardButton("Нет", callback_data="не принимается"))
        bot.send_message(
            call.message.chat.id, "Это бутылка или банка с точкой на дне?", parse_mode="html", reply_markup=markup
        )
        ...
        bot.send_message(call.message.chat.id, "Можно смять?", parse_mode="html", reply_markup=markup)
    elif call.data == "пластик, 1, сминаем":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Готово", callback_data="пластик, 1, сдать"))
        bot.send_message(call.message.chat.id, "Нужно смять", parse_mode="html", reply_markup=markup)
...
def plastic24(call):
    if call.data == "пластик, 24":
        ...
        bot.send_message(call.message.chat.id, "Это плёнка или пакет?", parse_mode="html", reply_markup=markup)
    elif call.data == "пластик, 24, мягкий":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Да", callback_data="не принимается"))
        markup.add(types.InlineKeyboardButton("Нет", callback_data="пластик, 24, накл"))
        bot.send_message(call.message.chat.id, "Это упаковка от заморозки?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(call.message.chat.id, "Есть бумажные наклейки?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(
            call.message.chat.id, "Это тюбик (например от крема для рук)?", parse_mode="html", reply_markup=markup
        )
    elif call.data == "пластик, 24, твёрдый, сдать":
        bot.send_message(call.message.chat.id, "Принимается на акции в <i><b>2,4 твёрдый</b></i>.", parse_mode="html")
...
def plastic5(call):
    if call.data == "пластик, 5":
        ...
        bot.send_message(call.message.chat.id, "Есть фольгированный блеск?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(call.message.chat.id, "Принимается на акции в <b><i>5 PP мягкий</i></b>.", parse_mode="html")
        main_menu(call.message)
    elif call.data == "пластик, 5, тв, сдать":
        bot.send_message(call.message.chat.id, "Принимается на акции в <b><i>5 PP твёрдый</i></b>.", parse_mode="html")
        main_menu(call.message)
...
def plastic6(call):
    if call.data == "пластик, 6":
        ...
        markup.add(types.InlineKeyboardButton("Нет", callback_data="не принимается"))
        bot.send_message(call.message.chat.id, "Упаковка вспененная?", parse_mode="html", reply_markup=markup)
    elif call.data == "пластик, 6, перфорация":
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Да", callback_data="не принимается"))
        markup.add(types.InlineKeyboardButton("Нет", callback_data="пластик, 6, этикетки"))
        bot.send_message(
            call.message.chat.id, "Есть перфорация (маленькие дырочки) на дне?", parse_mode="html", reply_markup=markup
        )
        ...
        bot.send_message(call.message.chat.id, "Есть бумажные этикетки?", parse_mode="html", reply_markup=markup)
        ...
        bot.send_message(
            call.message.chat.id, "Принимается на акции в <i><b>6 PS вcпененный</b></i>.", parse_mode="html"
        )
        main_menu(call.message)
...
def plastic_not_mark(call):
    if call.data == "пластик, бм":
        ...
        bot.send_message(call.message.chat.id, "Это пластиковый пакет?", parse_mode="html", reply_markup=markup)
        ...
        if call.data == "пластик, бм, пакет":
            ...
            bot.send_message(call.message.chat.id, "Пакет биоразлагаемый?", parse_mode="html", reply_markup=markup)
        elif call.data == "пластик, бм, пакет, чист":
            markup = types.InlineKeyboardMarkup()
            markup.add(types.InlineKeyboardButton("Да", callback_data="пластик, 24, накл"))
            markup.add(types.InlineKeyboardButton("Нет", callback_data="не принимается"))
            bot.send_message(call.message.chat.id, "Пакет чистый?", parse_mode="html", reply_markup=markup)
        ...
        if call.data == "пластик, бм, не пакет":
            ...
            bot.send_message(
                call.message.chat.id, "Это строительная стретч-плёнка?", parse_mode="html", reply_markup=markup
            )
            ...
            bot.send_message(
                call.message.chat.id, 'Это пупырчатая плёнка ("антистресс")?', parse_mode="html", reply_markup=markup
            )
            ...
            bot.send_message(call.message.chat.id, "Это пенопласт?", parse_mode="html", reply_markup=markup)
        elif call.data == "пластик, бм, не пенопласт":
            markup = types.InlineKeyboardMarkup()
            markup.add(types.InlineKeyboardButton("Да", callback_data="пластик, бм, вспен полиэт"))
            markup.add(types.InlineKeyboardButton("Нет", callback_data="не принимается"))
            bot.send_message(
                call.message.chat.id, "Это вспененная упаковочная плёнка?", parse_mode="html", reply_markup=markup
            )

    elif call.data == "пластик, бм, стретч":
        bot.send_message(call.message.chat.id, "Принимается на акции в <i><b>стретч-плёнка</b></i>.", parse_mode="html")
        main_menu(call.message)
    elif call.data == "пластик, бм, пупырка":
        bot.send_message(call.message.chat.id, "Принимается на акции в <i><b>пупырку</b></i>.", parse_mode="html")
        main_menu(call.message)
    elif call.data == "пластик, бм, вспен полиэт":
        bot.send_message(
            call.message.chat.id,
            "Скорее всего, принимается на акции в <i><b>пакет с пакетами</b></i>, " + "но лучше уточнить у волонтёров.",
            parse_mode="html",
        )
        main_menu(call.message)
...
def group_link(message):
    ...
    if message.text in greetings:
        ...
        bot.send_message(message.chat.id, "Подробнее о маркировках здесь", parse_mode="html", reply_markup=markup)
    else:
